...
response = client.chat.completions.create(
    ...
    messages=[
        {"role": "user", "content": "Build a KG, knowledge Graph and give me the json-ld format from this text, I want something like this:{'@context': {'schema': 'http://schema.org/'},'@graph': [{'@id': ''#algorithm','@type': 'schema:Thing','schema:name': 'Algorithm','schema:description': 'A finite sequence of rigorous instructions used for computation.'},:" + text}
    ]
